...
import { Loader2, Mail, Phone, Building, User as UserIcon, MessageSquare } from "lucide-react";
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">View and manage contact submissions</p>
      </div>
