            ...
            <div className="prose prose-lg max-w-none space-y-8">
              ...
              <div className="bg-card p-6 rounded-lg border">
                <p className="text-foreground">
                  Welcome to GS Lubricants (formerly known as "Gouri Shankar Lubricants," and hereinafter referred to as 
                  "GS Lubricants," "we," "us," or "our"). These Terms of Service ("Terms") govern your use of our website 
                  and services related to lubricant manufacturing, oil recycling, and waste oil management. By accessing 
